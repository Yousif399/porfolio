    ...
    const links = [
        {
            ...
            child: (
                <>
                    Linkedin <img src={'https://img.icons8.com/?size=256&id=xuvGCOXi8Wyg&format=png'} width='50px' />
                </>
            ),
        ...
        },
        {
            ...
            child: (
                <>
                    GitHub <img src={'https://img.icons8.com/?size=256&id=12599&format=png'} width='50px' />
                </>
            ),
        ...
        },
        {
            ...
            child: (
                <>
                    Resume <img src={'https://img.icons8.com/?size=256&id=CgELV9WHcecG&format=png'} width='50px' />
                </>
            ),
            href: 'https://publuu.com/flip-book/312440/722234/page/1',
            style: 'rounded-br-md'
        }
    ]
    return (
